...
class TextStyles {
  ...
  static TextStyle font20Black700 = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeightHelper.bold,
    color: Colors.black,
  );
  static TextStyle font16gray400 = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.regular,
  ...
  static TextStyle font17white600 = TextStyle(
    fontSize: 17.sp,
  ...
  static TextStyle font15white600 = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: ColorsManager.white,
  );
  ...
  static TextStyle font20maincoloer500 = TextStyle(
    fontSize: 20.sp,
    fontWeight: FontWeightHelper.medium,
  ...
  static TextStyle font12Black700 = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeightHelper.bold,
    color: Colors.black,
  );

  static TextStyle font32Medium = TextStyle(
    fontSize: 32.sp,
    fontWeight: FontWeightHelper.medium,
  );
  ...
  static TextStyle font13black400 = TextStyle(
    fontSize: 13.sp,
    fontWeight: FontWeightHelper.regular,
  );
  ...
  static TextStyle font15black700 = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.bold,
  );
  ...
  static TextStyle font14BlackBlueBold = TextStyle(
    fontSize: 14.sp,
  ...
  static TextStyle font22white600 = TextStyle(
      fontSize: 22.sp,
      fontWeight: FontWeightHelper.semiBold,
      color: ColorsManager.white
  );
  ...
  static TextStyle font14white500 = TextStyle(
      fontSize: 14.sp,
      fontWeight: FontWeightHelper.medium,
      color: ColorsManager.white
  );
